...
#####PRECIPITATION#####
##GariepDam##
GariepDam = read_excel("C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\Bloem Stad Data.xlsx")
...
write_xlsx(GariepDam,"C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\BloemStad-Preci.xlsx")
...
write_xlsx(sens_slope_results,"C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\Sens_Slope_Results.xlsx")

cat("\nSens Slope results saved to:", "C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\Sens_Slope_Results.xlsx", "\n")
...
if (length(mk_results) > 0) {
  ...
  write_xlsx(all_mk_results_df, "C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\MannKendall_Results.xlsx")
  
  cat(paste0("Mann-Kendall test results saved to: ", "C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\MannKendall_Results.xlsx", "\n"))
} else {
...
for (col_name in columns_to_test) {
  ...
  pettitt_results[[col_name]] <- data.frame(
    Column = col_name,
    Probable_Change_Year = probable_change_year,
    P_Value = p_value,
    Average_Before_Change = avg_before_change,
    Average_After_Change = avg_after_change
  )
}
pettitt.test(GariepDam$OCT)
# Combine all results into a single data frame
...
write_xlsx(final_results_df, "C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\Pettitt_Test_Results.xlsx")

cat("Pettitt test results saved to:", "C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\Pettitt_Test_Results.xlsx", "\n")
...
output_file <- "C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\Likelihood_Ratio_Test_Results.xlsx"
...
# Define the output file path
output_file <- "C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\Regression_Results.xlsx"
...
# Define the output file path
output_file <- "C:\\Users\\AdonsMB\\OneDrive - University of the Free State\\Desktop\\Masters\\MASTERS 2025\\2025\\Bloem Stad\\MMK_Results_GariepDam.xlsx"
